...
export const DIAGNOSES: DiagnosisDef[] = [
  ...
  { code: "hfmref", display: "HFmrEF", family: "Heart failure", tags: ["hf"] },
  ...
  { code: "cad-ccs", display: "Chronic coronary syndrome", family: "Coronary", tags: ["cad"] },
  { code: "prior-mi", display: "Previous MI", family: "Coronary", tags: ["cad"] },
  { code: "prior-pci", display: "Previous PCI", family: "Coronary", tags: ["cad"] },
  { code: "prior-cabg", display: "Previous CABG", family: "Coronary", tags: ["cad"] },
  { code: "acs-stemi", display: "STEMI", family: "Coronary", tags: ["cad", "acs"] },
  { code: "acs-nstemi", display: "NSTEMI", family: "Coronary", tags: ["cad", "acs"] },
  ...
  { code: "t2dm", display: "Type 2 diabetes", family: "Comorbidity", tags: ["dm"] },
  ...
  { code: "obesity", display: "Obesity", family: "Comorbidity", tags: ["dm"] },
  { code: "stroke-tia", display: "Stroke / TIA", family: "Comorbidity", tags: [] },
  { code: "pad", display: "Peripheral arterial disease", family: "Comorbidity", tags: ["cad"] },
...
export const MEDICATIONS: MedicationDef[] = [
  m("sacubitril-valsartan", "Sacubitril/valsartan", "ARNI", "Heart failure", ["raas", "arni"], ["hf"], "mg", [24, 49, 97], ["BID"], RENAL_K, { doseLabels: ["24/26 mg", "49/51 mg", "97/103 mg"] }),
  m("ramipril", "Ramipril", "ACE inhibitor", "Heart failure", ["raas", "acei"], ["hf", "htn", "cad"], "mg", [1.25, 2.5, 5, 10], ["OD", "BID"], RENAL_K),
  m("perindopril", "Perindopril", "ACE inhibitor", "Blood pressure", ["raas", "acei"], ["htn", "cad"], "mg", [2, 4, 8], ["OD"], RENAL_K),
  m("lisinopril", "Lisinopril", "ACE inhibitor", "Blood pressure", ["raas", "acei"], ["htn", "hf"], "mg", [2.5, 5, 10, 20], ["OD"], RENAL_K),
  m("candesartan", "Candesartan", "ARB", "Heart failure", ["raas", "arb"], ["hf", "htn"], "mg", [4, 8, 16, 32], ["OD"], RENAL_K),
  m("valsartan", "Valsartan", "ARB", "Heart failure", ["raas", "arb"], ["hf", "htn"], "mg", [40, 80, 160], ["BID", "OD"], RENAL_K),
  m("losartan", "Losartan", "ARB", "Blood pressure", ["raas", "arb"], ["htn"], "mg", [25, 50, 100], ["OD"], RENAL_K),
  m("bisoprolol", "Bisoprolol", "Beta blocker", "Heart failure", ["bb"], ["hf", "cad", "af", "htn"], "mg", [1.25, 2.5, 3.75, 5, 7.5, 10], ["OD"], ["hr", "sbp"]),
  m("carvedilol", "Carvedilol", "Beta blocker", "Heart failure", ["bb"], ["hf", "cad"], "mg", [3.125, 6.25, 12.5, 25], ["BID"], ["hr", "sbp"]),
  m("metoprolol-succinate", "Metoprolol succinate", "Beta blocker", "Heart failure", ["bb"], ["hf", "cad", "af"], "mg", [12.5, 25, 50, 100, 200], ["OD"], ["hr", "sbp"]),
  m("spironolactone", "Spironolactone", "Steroidal MRA", "Heart failure", ["mra", "potassium-sparing"], ["hf", "htn"], "mg", [12.5, 25, 50], ["OD"], ["potassium", "creatinine", "egfr"]),
  m("eplerenone", "Eplerenone", "Steroidal MRA", "Heart failure", ["mra", "potassium-sparing"], ["hf", "cad"], "mg", [25, 50], ["OD"], ["potassium", "creatinine", "egfr"]),
  m("finerenone", "Finerenone", "Nonsteroidal MRA", "Cardiometabolic", ["mra", "potassium-sparing"], ["ckd", "dm"], "mg", [10, 20], ["OD"], ["potassium", "egfr"]),
  m("dapagliflozin", "Dapagliflozin", "SGLT2 inhibitor", "Heart failure", ["sglt2"], ["hf", "ckd", "dm"], "mg", [10], ["OD"], ["egfr"]),
  m("empagliflozin", "Empagliflozin", "SGLT2 inhibitor", "Heart failure", ["sglt2"], ["hf", "ckd", "dm"], "mg", [10], ["OD"], ["egfr"]),
  ...
  m("atorvastatin", "Atorvastatin", "Statin", "CAD / secondary prevention", ["statin"], ["cad", "lipids", "dm"], "mg", [10, 20, 40, 80], ["Nightly", "OD"], ["ldl-c", "alt"]),
  m("rosuvastatin", "Rosuvastatin", "Statin", "CAD / secondary prevention", ["statin"], ["cad", "lipids", "dm"], "mg", [5, 10, 20, 40], ["OD"], ["ldl-c", "alt"]),
  m("ezetimibe", "Ezetimibe", "Cholesterol absorption inhibitor", "CAD / secondary prevention", [], ["cad", "lipids"], "mg", [10], ["OD"], ["ldl-c"]),
  m("evolocumab", "Evolocumab", "PCSK9 antibody", "CAD / secondary prevention", [], ["cad", "lipids"], "mg", [140], ["Every 2 weeks"], ["ldl-c"], { routes: ["SC"] }),
  m("inclisiran", "Inclisiran", "PCSK9 siRNA", "CAD / secondary prevention", [], ["cad", "lipids"], "mg", [284], ["Day 0, 3 months, then every 6 months"], ["ldl-c"], { routes: ["SC"] }),
  ...
  m("semaglutide", "Semaglutide", "GLP-1 receptor agonist", "Cardiometabolic", ["glp1"], ["dm", "cad"], "mg", [0.25, 0.5, 1, 2], ["Weekly"], ["weight", "hba1c"], { routes: ["SC"] }),
  m("tirzepatide", "Tirzepatide", "Dual GIP/GLP-1 agonist", "Cardiometabolic", ["glp1"], ["dm"], "mg", [2.5, 5, 7.5, 10, 12.5, 15], ["Weekly"], ["weight", "hba1c"], { routes: ["SC"] }),
